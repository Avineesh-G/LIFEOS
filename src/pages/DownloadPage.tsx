      ...
      <main className="relative z-10">
        ...
        <section className="pt-16 pb-16 px-4 sm:px-6 text-center max-w-4xl mx-auto space-y-8">
          ...
          >
            ...
            <span>v1.2.1 Live Release • 100% Free & Universal</span>
          </motion.div>
          ...
          >
            ...
            >
              ...
              <div className="text-left">
                ...
                <div className="text-[11px] font-medium text-white/80">Direct APK • v1.2.1 • ~8.5 MB Free</div>
              </div>
        ...
        <section className="py-20 px-4 sm:px-6 text-center">
          ...
          >
            ...
            <div className="pt-2 flex flex-col sm:flex-row items-center justify-center gap-3">
              ...
              >
                <Download size={18} />
                <span>Download LifeOS.apk (v1.2.1)</span>
              </motion.a>
