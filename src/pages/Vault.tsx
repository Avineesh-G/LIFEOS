      ...
      <AnimatePresence>
        {toastMessage && (
          <motion.div
            ...
            className="fixed left-1/2 -translate-x-1/2 z-50 px-4 py-2 rounded-2xl bg-black/90 dark:bg-white/95 text-white dark:text-black text-xs font-bold shadow-xl flex items-center gap-2 border border-white/20 dark:border-black/20"
          >
